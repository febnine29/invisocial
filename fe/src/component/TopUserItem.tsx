...
export default function TopUserItem({user, index}:any){
    ...
    useEffect(() => {
        ...
        try {
            const response = await axios.get(`http://localhost:5000/api/v1/auth/getUserId=${user.followedUserId}`);
            ...
            <Flex>
                ...
                <Flex flexDirection='column' ml={2}>
                    <Text 
                        ...
                        onClick={() => navigate(`/profileId/${user.followedUserId}`)}
